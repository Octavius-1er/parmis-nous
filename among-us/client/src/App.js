  ...
  return (
    <div className="screen lobby-screen">
      <div className="lobby-container">
        ...
        {isHost ? (
          <div>
            <p className="lobby-hint">{playerList.length < 4 ? `Besoin de ${4 - playerList.length} joueur(s) de plus` : 'Prêt à jouer !'}</p>
            <button className="btn btn-start" onClick={startGame} disabled={playerList.length < 4}>
              Démarrer la partie
            </button>
          </div>
        ) : (
            ...
            <div className="vote-panel">
              ...
              <div className="vote-grid">
                {alivePlayers.map(p => (
                  ...
                  >
                    <div className="vote-astronaut">🧑‍🚀</div>
